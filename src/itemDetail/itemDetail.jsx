...
const itemDetail = [
  {
    id: 1,
    name: 'AI Humanoid Intelligent Robots Restaurant Waitress Food delivery Robot (Red)',
    description:
  ...
  {
    id: 2,
    name: 'iRobot Roomba j7+ (7550) Self-Emptying Robot Vacuum – Identifies and avoids obstacles like pet waste & cords, Empties itself for 60 days, Smart Mapping, Works with Alexa, Ideal for Pet Hair, Graphite',
    description:
      "Food Delivery Deliver the meal to the guest's designated table, then explain the restaurant information, the waiter or the guest touches the robot's screen and the robot goes to the next table or returns to the starting point to charging.Multi-point Delivery Robot can deliver the food to one table, can also deliver the good to three different tables in one order",
    price: 599,
    type: 'house',
  ...
  {
    id: 5,
    name: 'UNITREE GO1 Pro Robot Dog Toy Artificial Intelligence accompanying Technology Dog',
    description:
  ...
  },
  {
    ...
    description:
      'Pepper is a humanoid robot designed to interact with people – assist them, share information with them, and help customers at retail stores.Pepper is about four feet tall, has a tablet (that displays information) in the center of its chest, can gesticulate and talk in several languages.The robot uses emotion recognition AI to interpret and respond to human activity. It can recognize human emotions like joy and respond accordingly with a smile, for example.In a store, Pepper can make personalized recommendations and help customers find the products they’re looking for. Moreover, it can sell, cross-sell, and communicate with the human team.Pepper operates in environments like banks, hotels, pizzas, and hospitals to improve customer experience and help organizations lower costs.',
    price: 6999,
    type: 'business',
    stock: 10,
    image:
  ...
  {
    id: 8,
    name: 'Penny Restaurant Robot',
    description:
      'Penny is a bowling pin-shaped food-service robot enabled by artificial intelligence. It can autonomously shuttle food and drinks from a restaurant kitchen out to tables and bring dishes back for a cleaning.Penny can run in different food service environments such as dining rooms, pizzerias, large banquet halls, casino gaming floors, restaurants, cafés, etc.This self-driving robot can seamlessly deliver several beverages at once. It is powered by a long-lasting battery (with life 8 – 12hrs), which allows it to operate on night shifts or peak hours.The goal is Penny to take the plates to the bussing station and reduce the waiting time.Thus, the servers can focus more on improving customer experience, address diner’s needs, and ask how the table enjoyed the meal, for example.',
    price: 3599,
    type: 'business',
    stock: 9,
    image:
